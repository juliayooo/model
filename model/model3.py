...
def create_dataset(image_dir, landmark_file, batch_size=32):
...
merged = layers.concatenate([model.output, x])
...
train_dataset = create_dataset("split_human_faces_resized/train/",
                               "split_human_faces_resized/train/train_face_landmarks.npz")
val_dataset = create_dataset("split_human_faces_resized/val/", "split_human_faces_resized/val/val_face_landmarks.npz")
